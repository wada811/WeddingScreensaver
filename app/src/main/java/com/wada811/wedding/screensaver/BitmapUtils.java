...
public class BitmapUtils{
     ...
     * @return bitmap
     */
    public static Bitmap createBitmapFromYuv(byte[] yuvData, int width, int height){
     ...
     *
     * @param yuvData preview raw data
     * @param imageFormat ImageFormat.NV21 | ImageFormat.YUY2
